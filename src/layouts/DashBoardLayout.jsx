...
import { Menu, Home, Package, Send, User } from 'lucide-react'; // Kichu icons logic er jonno
        ...
        <div className="drawer lg:drawer-open">
            ...
            <div className="drawer-side z-50">
                ...
                <ul className="menu p-6 w-80 min-h-full bg-slate-900 text-slate-300">
                    ...
                    {/* Navigation Items */}
                    <p className="text-xs font-bold text-slate-500 uppercase mb-4 px-4 tracking-widest">User Panel</p>
                    
                    <li className="mb-2">
                        <Link to="/dashboard/sendParcel" className="flex items-center gap-3 py-3 px-4 hover:bg-orange-600 hover:text-white rounded-xl transition-all font-bold">
                            <Send size={20} /> Send New Parcel
                        </Link>
                    </li>
                    <li className="mb-2">
                        <Link to="/dashboard/myParcels" className="flex items-center gap-3 py-3 px-4 hover:bg-orange-600 hover:text-white rounded-xl transition-all font-bold">
                            <Package size={20} /> My Parcels
                        </Link>
                    </li>
                    <li className="mb-6">
                        <Link to="/dashboard/profile" className="flex items-center gap-3 py-3 px-4 hover:bg-orange-600 hover:text-white rounded-xl transition-all font-bold">
                    ...
                    <li>
                        <Link to="/" className="flex items-center gap-3 py-3 px-4 hover:bg-slate-800 rounded-xl transition-all font-bold">
